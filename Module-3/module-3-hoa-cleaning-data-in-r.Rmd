---
title: An R Markdown document converted from "C:\Users\saswa\Downloads\module-3-hoa-cleaning-data-in-r.ipynb"
...
In order to start cleaning your data, you will need to install the required packages. If you have already installed and loaded `tidyverse`, `skimr`, and `janitor` in this session, feel free to skip the code chunks in this step.
...
```{r}
bookings_df <- read_csv("/kaggle/input/hotel-bookings-main/hotel_bookings.csv")
```
...
## Activity Wrap Up
Now you have some experience cleaning and analyzing data in `R`; you used basic cleaning functions like `rename()` and `clean_names()` and performed basic calculations on real data. One of the reasons `R` is such a powerful tool for data analysis is because you can perform so many different tasks in one place. With the functions you have been learning in this course, you can import data, create and view data frames, and even clean data without leaving your console.  
