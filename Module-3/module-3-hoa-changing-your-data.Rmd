---
title: An R Markdown document converted from "C:\Users\saswa\Downloads\module-3-hoa-changing-your-data.ipynb"
...
```{r}
hotel_bookings <- read_csv("/kaggle/input/hotel-bookings-main/hotel_bookings.csv")

#additional: > spec(hotel_bookings)- to get the info about all the columns.
```
...
You quickly check what the average lead time for this set of hotels is, just like you did for all hotels before:
...
## Activity Wrap Up
Being able to manipulate data is a key skill for working in `R`. After this activity, you should be more familiar with functions that allow you to change your data, such as `arrange()`, `group_by()`, and `filter()`. You also have some experience using statistical summaries to make insights into your data. As you practice, consider how performing tasks is similar and different in `R` compared to other tools.
