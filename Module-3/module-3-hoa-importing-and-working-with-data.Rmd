---
title: An R Markdown document converted from "C:\Users\saswa\Downloads\module-3-hoa-importing-and-working-with-data.ipynb"
...
```{r}
avocado_df<-read_csv("/kaggle/input/avocado/avocado.csv")
```
